...
import { Scene, Head, BigLine, Disclaimer, bone, boneSoft, boneSofter, text2, gold, goldLight, hairline } from "@/components/forge/primitives";
...
type Content = Widen<typeof KUZNYA_LANDING>;

/**
 * The whole Кузня page, minus its metadata. Both routes render this — the
 * Russian one at /forge, the Ukrainian at /ua/forge — so the layout can never
 * drift between languages: only the words are passed in.
 */
export function ForgeView({ L, locale }: { L: Content; locale: "ru" | "uk" }) {
  return (
    <>
